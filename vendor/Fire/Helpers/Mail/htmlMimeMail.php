...
class htmlMimeMail
{
    ...
    */
    ...
    /**
     *
     * Encodes the subject header to base64.
     * @param   string  $input
        ...
        switch ($type) {
            case 'mail':
                ...
                if (!empty($this->headers['Subject'])) {
                    $subject_in_raw_format = $this->headers['Subject'];
                    $subject = $this->encodeSubject($this->headers['Subject'], $this->build_params['head_charset']);
                ...
                if ($subject !== '') {
                    $this->headers['Subject'] = $subject_in_raw_format;
                }
